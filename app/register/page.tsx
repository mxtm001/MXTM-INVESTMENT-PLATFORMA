    ...
    <div className="min-h-screen bg-[#050e24] text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Available worldwide - Start with $2,000,000</p>
          <div className="mt-2">
            <TimezoneDisplay />
          </div>
        </div>
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-4">
                  Your account has been created with a starting balance of $2,000,000
                </p>
          ...
          <Card className="bg-[#0a1735] border-[#253256]">
            ...
            <CardContent>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="bg-[#162040] p-3 rounded-md border border-[#253256]">
                  <div className="flex items-center mb-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    <span className="text-sm text-white">Starting Balance: $2,000,000</span>
                  </div>
                  <div className="flex items-center mb-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    <span className="text-sm text-white">Global Currency Support</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    <span className="text-sm text-white">24/7 Worldwide Support</span>
                  </div>
                </div>
